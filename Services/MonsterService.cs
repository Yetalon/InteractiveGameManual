    ...
    public class MonsterService : ICharacter{
        ...
        public MonsterService()
        {
            ...
            AllCharacters.Add(new Character{
                ...
                Power = Rnd.Next(2,6),
                ImageURL = "https://files.oaiusercontent.com/file-LyNvpvcbxkbkfy0H3UamE56q?se=2024-10-03T13%3A34%3A03Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3Dcfb957f4-b24a-47eb-91df-d8a49bb905c0.webp&sig=LVbEeQ5cZrGxW/gGf4CKK84mwg1aZrw5OzHOneJsVxM%3D",
                Name = "Monster"
            });
